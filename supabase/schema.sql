...
-- CASCADE automatically drops all dependent policies/indexes
-- ============================================================================

alter table public.entities drop column if exists user_id cascade;
alter table public.vaults drop column if exists user_id cascade;
alter table public.transactions drop column if exists user_id cascade;
alter table public.settings drop column if exists user_id cascade;
